    ...
    <div>
      {!loggedUser && (
        <div className={styles.loginregisterbuttons}>
          ...
          <img src="https://res.cloudinary.com/drv1kbmgi/image/upload/h_28/v1701966155/Proyecto%20Final%20Figma/login_nntogf.png" alt="Login icon" role="button" />
          </Link>
          <Link to={"/register"} style={{color:'inherit'}} >
            <img src="https://res.cloudinary.com/drv1kbmgi/image/upload/h_30/v1702916316/FP%20icons/New_user_icon-01.svg_rimufa.png" alt="Register icon" role="button"/>
          </Link>
        </div>
      )}
      {loggedUser && (
